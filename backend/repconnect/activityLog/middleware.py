...
_MODULE_PATTERNS: list[tuple[re.Pattern[str], str]] = [
    ...
    (re.compile(r'^/api/training/', re.I),        'Training Evaluation'),
    (re.compile(r'^/api/employee-eval/', re.I),   'Employee Evaluation'),
    (re.compile(r'^/api/announcements/', re.I),    'Announcements'),
    (re.compile(r'^/api/mis/', re.I),              'MIS Ticket'),
...
_EXACT_ACTIONS: list[tuple[str, str, str]] = [
    ...
    # Training Evaluation
    ('GET',   '/training/admin',                    'Viewed training list'),
    ('POST',  '/training/admin',                    'Created training'),
    ('PATCH', '/training/admin/',                   'Updated training'),
    ('DELETE','/training/admin/',                   'Deleted training'),
    ('GET',   '/training/admin/',                   'Viewed training details'),
    ('GET',   '/training/my',                       'Viewed my training evaluations'),
    ('GET',   '/training/my/',                      'Opened training evaluation'),
    ('POST',  '/training/my/',                      'Saved training answer'),
    ('POST',  '/training/my/',                      'Submitted training evaluation'),
    ('GET',   '/training/approver/queue',           'Viewed training approval queue'),
    ('GET',   '/training/approver/submissions/',    'Viewed training submission detail'),
    ('POST',  '/training/approver/steps/',          'Acted on training approval step'),
    # Employee Evaluation
    ('GET',   '/employee-eval/settings',                      'Viewed evaluation settings'),
    ('PATCH', '/employee-eval/settings',                      'Updated evaluation settings'),
    ('GET',   '/employee-eval/admin/periods',                 'Viewed evaluation periods'),
    ('PATCH', '/employee-eval/admin/periods/',                'Updated evaluation period'),
    ('POST',  '/employee-eval/admin/periods/',                'Toggled evaluation period status'),
    ('GET',   '/employee-eval/admin/periods/',                'Viewed evaluation period results'),
    ('GET',   '/employee-eval/admin/entries',                 'Viewed evaluation entries'),
    ('GET',   '/employee-eval/admin/chart',                   'Viewed evaluation chart'),
    ('GET',   '/employee-eval/admin/tasklists',               'Viewed employee tasklists'),
    ('GET',   '/employee-eval/admin/tasklists/',              'Viewed employee tasklist detail'),
    ('POST',  '/employee-eval/admin/tasklists/',              'Updated employee tasklist'),
    ('POST',  '/employee-eval/admin/tasklists/delete-all',    'Deleted all tasklists (override import)'),
    ('POST',  '/employee-eval/admin/tasklists/validate',      'Validated tasklist import file'),
    ('POST',  '/employee-eval/admin/tasklists/import',        'Imported tasklists from file'),
    ('GET',   '/employee-eval/admin/tasklists/template',      'Downloaded tasklist import template'),
    ('GET',   '/employee-eval/my',                            'Viewed own evaluation'),
    ('POST',  '/employee-eval/my/scores',                     'Saved self-evaluation scores'),
    ('POST',  '/employee-eval/my/submit',                     'Submitted self-evaluation'),
    ('POST',  '/employee-eval/my/confirm',                    'Confirmed self-evaluation'),
    ('GET',   '/employee-eval/approver/queue',                'Viewed evaluation approval queue'),
    ('GET',   '/employee-eval/approver/entries/',             'Viewed evaluation entry detail'),
    ('POST',  '/employee-eval/approver/steps/',               'Saved supervisor evaluation scores'),
    ('POST',  '/employee-eval/approver/steps/',               'Submitted supervisor evaluation'),
    ('POST',  '/employee-eval/approver/steps/',               'Acted on final approval step'),
    ('GET',   '/employee-eval/entries/',                      'Viewed evaluation timeline'),
]

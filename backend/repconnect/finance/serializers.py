...
class AllowanceTypeSerializer(serializers.ModelSerializer):
    class Meta:
        model = AllowanceType
        fields = ('id', 'name', 'replace_on_upload', 'created_at')


class LoanTypeSerializer(serializers.ModelSerializer):
    class Meta:
        model = LoanType
        fields = ('id', 'name', 'stackable', 'created_at')
...
class AllowanceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'allowance_type', 'allowance_type_name', 'amount', 'description', 'created_at',
        )
...
class SavingsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            'id', 'employee_idnumber', 'employee_firstname', 'employee_lastname',
            'savings_type', 'savings_type_name', 'amount', 'description', 'created_at',
        )

...
class AllowanceTypeAdmin(admin.ModelAdmin):
    list_display = ('name', 'replace_on_upload', 'created_at')
    list_filter = ('replace_on_upload',)
    search_fields = ('name',)
    ordering = ('name',)
...
class AllowanceAdmin(admin.ModelAdmin):
    list_display = ('employee', 'allowance_type', 'amount', 'description', 'created_at')
...
class DeductionAdmin(admin.ModelAdmin):
    list_display = ('employee', 'loan', 'amount', 'description', 'created_at')
    list_filter = ('created_at',)
    search_fields = (
        'employee__username',
        'employee__first_name',
        'employee__last_name',
        'loan__loan_type__name',
        'description',
    )
    date_hierarchy = 'created_at'
    raw_id_fields = ('employee', 'loan')


@admin.register(Savings)
class SavingsAdmin(admin.ModelAdmin):
    list_display = ('employee', 'savings_type', 'amount', 'description', 'created_at')
    list_filter = ('savings_type', 'created_at')
    search_fields = ('employee__username', 'employee__first_name', 'employee__last_name', 'description')
    date_hierarchy = 'created_at'

...
from .serializers import PRFRequestSerializer, EmergencyLoanCreateSerializer, PRFAdminSerializer, PRFAdminActionSerializer
...
class EmergencyLoanCreateView(APIView):
    ...
    def post(self, request):
        ...
        # Generate the EL control number first (inside the atomic block)

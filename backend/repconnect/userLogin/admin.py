...
from .models import loginCredentials, LoginAttempt, EmployeeSnapshot
...
class LoginCredentialsAdmin(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        """Ensure related permission flags mirror the `admin` flag when admin is enabled."""
...
class EmployeeSnapshotAdmin(admin.ModelAdmin):
    list_display = ['snapshot_date', 'total', 'regular', 'probationary', 'ojt', 'male', 'female', 'updated_at']

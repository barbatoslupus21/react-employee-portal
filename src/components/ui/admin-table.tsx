...
export function AdminTable<TRow>({
  ...
  return (
    ...
    >
      ...
      <div
        className="overflow-x-hidden max-[780px]:overflow-x-auto transition-opacity duration-200 max-[780px]:[scrollbar-width:none] max-[780px]:[&::-webkit-scrollbar]:hidden"

...
export const CHART_ANIMATION = {
  ...
  line:    { duration: 1200, easing: 'ease-in-out' as const },
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <ResponsiveContainer width="100%" height="100%">
            {chartType === 'bar' ? (
              <BarChart data={data} margin={CHART_STYLE.margin}>
                <defs>
                  {categories.map(cat => (
                    <linearGradient key={cat.gradId} id={cat.gradId} x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor={cat.lightColor} />
                ...
                <defs>
                  {categories.map(cat => (
                    <linearGradient key={`ag-${cat.gradId}`} id={`ag-${cat.gradId}`} x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%"   stopColor={cat.color} stopOpacity={0.22} />

...
export function DateTimePicker({
  ...
  const popoverContent = open ? (
    <div
      ...
      style={popoverStyle}
      className={cn(
        "w-[272px] rounded-xl border border-[var(--color-border-strong)]",
        ...
        <div className="mt-3 -mx-3 px-3 pt-2.5 border-t border-[var(--color-border)]">
          ...
          <input
            ...
            className={cn(
              ...
              "focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)]/30 focus:border-transparent"
            )}
          />
        </div>
      )}
    ...
    <div className={cn("relative", className)}>
      ...
      <button
        ...
        className={cn(
          ...
          formattedLabel ? "text-[var(--color-text-primary)]" : "text-[var(--color-text-muted)]",
          !disabled && "hover:border-[var(--color-accent)]",
          "focus:outline-none",
          open && "ring-2 ring-[var(--color-accent)]/40 border-[var(--color-accent)]",

...
>(({ className, align = "center", side = "bottom", sideOffset = 4, avoidCollisions = false, showArrow = false, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    ...
    >
      {props.children}
      {showArrow && (
        <PopoverPrimitive.Arrow className="-my-px fill-[var(--color-bg-elevated)]" />
      )}
    </PopoverPrimitive.Content>
  </PopoverPrimitive.Portal>
));

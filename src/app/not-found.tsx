...
export default function NotFound() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[var(--color-bg)] flex items-center justify-center px-4 sm:px-6 lg:px-8 relative">

        <div className="w-full max-w-4xl mx-auto text-center">
          <div className="animate-fade-in-up space-y-6 sm:space-y-2">
            ...
            <h1
              className="text-5xl font-bold text-[var(--color-text-primary,#0f172a)] animate-fade-in-up"
            ...
            <p
              className="text-xs text-[var(--color-text-muted,#64748b)] max-w-md sm:max-w-lg lg:max-w-2xl mx-auto leading-relaxed px-4 sm:px-0 animate-fade-in-up"
            ...
            <div
              className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-3 justify-center items-center px-4 sm:px-0 animate-fade-in-up"
              style={{ animationDelay: '0.6s' }}
            >
              <Button
                  onClick={() => router.push('/dashboard')}
                size="sm"
                className="group text-normal text-white w-full sm:w-auto transition-all duration-200 hover:scale-[1.02] hover:shadow-md active:scale-[0.98] min-h-[48px] sm:min-h-[44px]"
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="group w-full text-normal text-[var(--color-text-primary)] sm:w-auto transition-all duration-200 hover:scale-[1.02] hover:shadow-sm active:scale-[0.98] min-h-[48px] sm:min-h-[44px]"
                aria-label="Go back"
              >
            ...
            <p
              className="text-[12px] pt-2 text-[var(--color-text-muted,#64748b)] px-4 sm:px-0 animate-fade-in-up"

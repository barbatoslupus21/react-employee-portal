...
const serverAnimationCSS = `
  ...
  @keyframes estroboscopico1 {
    ...
    25%, 75%      { fill: rgb(16, 53, 115); }
  }
  @keyframes estroboscopico2 {
    0%, 50%, 100% { fill: #17e300; }
    25%, 75%      { fill: #17e300b4; }
  }
  #strobe_led1    { animation: estroboscopico  0.5s infinite; }
  #strobe_color1  { animation: estroboscopico2 0.8s infinite; }
  #strobe_color3  { animation: estroboscopico1 0.8s infinite; animation-delay: 3s; }
    ...
    <div className="container_SevMini">
      <div className="SevMini">
        <svg width={74} height={90} viewBox="0 0 74 90" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M63 69.5L65.5 68V71L63 72.5V69.5Z" fill="#17e300b4" />
          ...
          <path d="M63 51.5L65.5 50V53L63 54.5V51.5Z" fill="#FF715E" />
          ...
          <mask id="cs_mask0_2_176" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x={11} y={51} width={14} height={11}>
            <path d="M11 52.755C11 51.9801 11.8432 51.4997 12.5098 51.8947L23.5196 58.419C24.1273 58.7792 24.5 59.4332 24.5 60.1396V60.245C24.5 61.0199 23.6568 61.5003 22.9902 61.1053L11.9804 54.581C11.3727 54.2208 11 53.5668 11 52.8604V52.755Z" fill="#396CAA" />
          </mask>
          <g mask="url(#cs_mask0_2_176)">
          ...
          <mask id="cs_mask1_2_176" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x={19} y={9} width={38} height={23}>
            <path d="M20.1902 22.0719C18.8101 21.3026 18.8252 19.3119 20.2168 18.5636L36.1054 10.0189C37.2884 9.3827 38.7116 9.3827 39.8946 10.0189L55.7832 18.5636C57.1748 19.3119 57.1899 21.3026 55.8098 22.0719L40.4345 30.6429C38.9211 31.4865 37.0789 31.4865 35.5655 30.6429L20.1902 22.0719Z" fill="#396CAA" />
          </mask>
          <g mask="url(#cs_mask1_2_176)">
...
export default function ComingSoonPage() {
  ...
  return (
    <>
      <style>{serverAnimationCSS}</style>

      <div className="min-h-screen bg-[var(--color-bg-page,#f8fafc)] flex items-center justify-center px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="w-full max-w-4xl mx-auto text-center">
          <div className="animate-fade-in-up space-y-6 sm:space-y-8">
            ...
            <div className="animate-bounce-in flex justify-center">
              {mounted && <ServerLoader />}
            </div>

            <h1
              className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-[var(--color-text-primary,#0f172a)] animate-fade-in-up"
            ...
            <p
              className="text-base sm:text-lg lg:text-xl text-[var(--color-text-muted,#64748b)] max-w-md sm:max-w-lg lg:max-w-2xl mx-auto leading-relaxed px-4 sm:px-0 animate-fade-in-up"
              style={{ animationDelay: '0.4s' }}
            >
              This module is currently under development. Our team is working hard to bring
            ...
            >
              <Button
                ...
                size="lg"
                className="group w-full sm:w-auto transition-all duration-200 hover:scale-[1.02] hover:shadow-md active:scale-[0.98] min-h-[48px] sm:min-h-[44px]"
              ...
              <Button
                ...
                size="lg"
                disabled
                className="group w-full sm:w-auto min-h-[48px] sm:min-h-[44px] cursor-not-allowed opacity-60"
                aria-label="Module under construction"
              >
            ...
            <p
              className="text-xs sm:text-sm text-[var(--color-text-muted,#64748b)] px-4 sm:px-0 animate-fade-in-up"
              style={{ animationDelay: '0.8s' }}
            >
              Need access sooner? Contact your system administrator.
            </p>
          </div>
        </div>
      </div>
